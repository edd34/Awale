		...
		if (!Application.loadedLevelName.Contains ("LevelSelect") 
		    ...
		    && !Application.loadedLevelName.Contains("Main") ){
						if (VolMusicButton == null) {
								VolMusicButton = MainCamObj.transform.Find ("PauseMenu").Find ("VolMusic").Find ("ButtonGUI").GetComponent<ButtonEvent> ();
								VolMusicButton.receiver = gameObject;
						}
						if (VolSFXButton == null) {
								VolSFXButton = MainCamObj.transform.Find ("PauseMenu").Find ("VolSFX").Find ("ButtonGUI").GetComponent<ButtonEvent> ();
...
*/
	...
	void LevelBeaten(){
		if(BeatenMenu == null)	BeatenMenu = Camera.main.transform.Find("BeatenMenu").gameObject;
...
*/
	...
	public void Pause(){
		PopupMenu pauseMenu = Camera.main.transform.Find("PauseMenu").GetComponent<PopupMenu>();
	...
	public void UnpauseMaybe(){
		...
		GameObject pauseMenu = 	Camera.main.transform.Find("PauseMenu").gameObject;
		if(pauseMenu != null)
